...
ren county state
save "$analysis_files/births/idhw_births_idaho", replace
...
do "/Users/elizabethbageant/Dropbox/_MCCLURE/Demography--Growth in Idaho/Analysis/county_cleaner"
ren county_name county

save "$analysis_files/births/idhw_births_county", replace
...
save "$analysis_files/births/idhw_births_idaho_by_age", replace
...
save "$analysis_files/births/idhw_births_county_by_age", replace
...
* State level
	...
	* How many 15-44 year olds are there in Idaho, by year? Using PEP estimates.
	use "/Users/elizabethbageant/Dropbox/_MCCLURE/Demography--Growth in Idaho/Analysis/analysis_files/age_and_sex/age_5yearbins_county.dta", clear
	...
	* bring in IDHW births data
	merge 1:1 year using "$analysis_files/births/idhw_births_idaho"
	...
	* Birth rate = (births/women 15-44)*1000
	...
	export delimited using "/Users/elizabethbageant/Dropbox/_MCCLURE/Demography--Growth in Idaho/Analysis/analysis_files/births/state_birth_rates.csv"
...
* County level
	...
	* bring in IDHW births data
	merge 1:1 year county using "$analysis_files/births/idhw_births_county"
	...
	* Birth rate = (births/women 15-44)*1000
	...
	export delimited using "/Users/elizabethbageant/Dropbox/_MCCLURE/Demography--Growth in Idaho/Analysis/analysis_files/births/county_birth_rates.csv"
