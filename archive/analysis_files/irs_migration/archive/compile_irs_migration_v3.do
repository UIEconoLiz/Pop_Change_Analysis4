...
* Import, tidy and standardize 2012-2022 outflow files
...
* Import, tidy and standardize 2012-2022 inflow files
	/* Note: Import files had headers and footers removed manually in 
	   excel to facilitate this step. */
...
save "$irs/processed/county_in_out_stay_2012-2022", replace
