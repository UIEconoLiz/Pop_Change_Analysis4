...
export delimited age_group totalpop mpop fpop using "$analysis_files/pop_pyramids/idaho_pop_by_agesex_acs5year_2010.csv", replace
...
* save a file for use in R
export delimited age_group totalpop mpop fpop using "$analysis_files/pop_pyramids/idaho_pop_by_agesex_acs5year_2022.csv", replace


/*------------ 2000 Census Counts --------------------------------------------*/

import excel "$data/Census population by age and sex/Other/st-est2002-asro-02-16.xls", sheet("import") firstrow clear

* This file is already in good shape. No cleaning needed. 

* save a file for use in R
export delimited using "$analysis_files/pop_pyramids/idaho_pop_by_agesex_census_2000.csv", replace
...
import excel "$data/Census population by age and sex/Other/s5yr8090_idaho_import", sheet("import") firstrow clear 
...
* save a file for use in R
export delimited age_group censuspop_1980 gender using "$analysis_files/pop_pyramids/idaho_pop_by_agesex_census_1980.csv", replace
export delimited age_group censuspop_1990 gender using "$analysis_files/pop_pyramids/idaho_pop_by_agesex_census_1990.csv", replace
