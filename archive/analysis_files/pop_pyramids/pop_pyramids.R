...
pep <- read.csv("/Users/elizabethbageant/Dropbox/_MCCLURE/Demography--Growth in Idaho/Analysis/analysis_files/age_and_sex/age_5yearbins_county.csv") %>% 
...
factor(pep$agecat, order = TRUE, levels = c("age04", "age59", "age1014", "age1519", "age2024", "age2529", "age3034", "age3539", "age4044", "age4549", "age5054", "age5559", "age6064", "age6569", "age7074", "age7579", "age8084", "age85plus"))
...
pyr2022 <- basic_plot +
  ...
  labs(
    x = "Age group", 
    y = "Estimated population", 
    title = "Idaho population structure 2022"
  )
