...
comp <- read.csv(paste(datapath, "/components_of_change_2000-2023.csv", sep = ""))
...
comp %>% 
  ...
  ggtitle("Idaho's population 2000-2023") +
  labs(caption = "Data source: U.S. Census Bureau Annual Resident Population Estimates Vintage 2009, Vintage 2019, Vintage 2023") +
  xlab("") +
  ylab("Population")
