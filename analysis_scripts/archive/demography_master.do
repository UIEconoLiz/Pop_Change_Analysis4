...
global do "$project/Analysis/analysis_scripts"
global analysis_files "$project/Analysis/analysis_files"
global analysis_data "$project/Analysis/analysis_data"

global pep "$project/Data/Census PEP"
global irs_import "$project/Data/IRS Statistics of Income/2011-2022/import"
...
* DMV--UPDATE WHEN JAAP SHARES DATA
do "$do/migration_dmv_compile_20241010.do"


* Migration comparison done in R
