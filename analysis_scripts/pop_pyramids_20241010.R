...
for (i in loop_years) {
  pep_state %>% 
    ...
    scale_fill_manual(values = c("#E8C32EFF", "#3B8086FF"), 
...
pep2000$cats <-  factor(pep2000$age_group, order = TRUE, levels = c("Under 5 years", "5 to 9 years", "10 to 14 years", "15 to 19 years", "20 to 24 years", "25 to 29 years", "30 to 34 years", "35 to 39 years", "40 to 44 years", "45 to 49 years", "50 to 54 years", "55 to 59 years", "60 to 64 years", "65 to 69 years", "70 to 74 years", "75 to 79 years", "80 to 84 years", "85 years and over"))
levels(pep2000$cats) 
